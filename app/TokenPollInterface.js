...
var hasVoted = async(tokenPoll, user) => { return await tokenPoll.getHasVoted(user, 0); };

var getUserVoteChoice = async(tokenPoll, user) => { return await tokenPoll.getVoteChoice(user, 0); };
